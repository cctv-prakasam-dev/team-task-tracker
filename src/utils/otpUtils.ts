import type { ActionType, OtpData, OtpEntity } from "../types/app.types.js";
...
export function prepareOtpData(entity: OtpEntity, action: ActionType, expireInMin = 15): OtpData {
